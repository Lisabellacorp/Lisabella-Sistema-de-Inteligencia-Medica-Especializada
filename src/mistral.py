...
class MistralClient:
    def __init__(self):
        ...
        self.max_retries = 3
        self.base_retry_delay = 2  # Reducido para evitar timeouts acumulados
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                with ThreadPoolExecutor(max_workers=1) as executor:
                    ...
                    # Timeout de 60 segundos para la respuesta
...
Por favor, intenta reformular tu pregunta o contacta al soporte."""
    ...
    def _call_mistral_api(self, question, domain, special_command):
        """Llamada real a la API de Mistral (separada para manejar timeout)"""
        ...
        response = self.client.chat.complete(
            ...
            max_tokens=4000  # Reducido para evitar demoras en generación
        )
    ...
    def _build_system_prompt(self, domain, special_command=None):
        ...
        # (Mantengo el código original completo, sin cambios)
